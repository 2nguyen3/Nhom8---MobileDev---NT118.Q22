...
public class HomeActivity extends AppCompatActivity {
    ...
    private void startFloatY(View view, float dpDistance, long duration, long delay) {
        ...
        float distancePx = dp(dpDistance);
    ...
    private void startPulseScaleAlpha(
            View view,
            float fromScale,
            float toScale,
            float fromAlpha,
    ...
    private void startLeafTop(View view) {
        ...
        ObjectAnimator moveX = ObjectAnimator.ofFloat(view, View.TRANSLATION_X, 0f, -dp(9), 0f);
        ObjectAnimator moveY = ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, 0f, dp(8), 0f);
    ...
    private void startLeafLeft(View view) {
        ...
        ObjectAnimator moveX = ObjectAnimator.ofFloat(view, View.TRANSLATION_X, 0f, dp(10), 0f);
        ObjectAnimator moveY = ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, 0f, -dp(7), 0f);
    ...
    private void startLeafRight(View view) {
        ...
        ObjectAnimator moveX = ObjectAnimator.ofFloat(view, View.TRANSLATION_X, 0f, -dp(6), 0f);
        ObjectAnimator moveY = ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, 0f, dp(8), 0f);
    ...
    private void startArrowShift(View view) {
        ...
        ObjectAnimator shift = ObjectAnimator.ofFloat(
                view,
                View.TRANSLATION_X,
                0f,
                dp(6),
    ...
    private void startAiReadyDotAnimation(View dot, View glow) {
        ...
        // Dot: thu nhỏ xuống trước, rồi nở ra, rồi quay về
        ObjectAnimator dotScaleX = ObjectAnimator.ofFloat(
                dot,
                View.SCALE_X,
                1.0f,
                0.72f,
        ...
        ObjectAnimator dotScaleY = ObjectAnimator.ofFloat(
                dot,
                View.SCALE_Y,
                1.0f,
                0.72f,
        ...
        ObjectAnimator dotAlpha = ObjectAnimator.ofFloat(
                dot,
                View.ALPHA,
                0.95f,
                0.88f,
        ...
        // Glow: nở rộng hơn dot rồi tan đi
        ObjectAnimator glowScaleX = ObjectAnimator.ofFloat(
                glow,
                View.SCALE_X,
                0.7f,
                1.9f,
        ...
        ObjectAnimator glowScaleY = ObjectAnimator.ofFloat(
                glow,
                View.SCALE_Y,
                0.7f,
                1.9f,
